...
<header class="relative w-full lg:h-[43vh] h-[55vh] flex items-center justify-center text-center" style="background-image: url('images/home/1.jpg'); background-size: cover; background-position: center;">
