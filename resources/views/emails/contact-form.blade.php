<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#D6D2C4"
            ...
            <table width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
                ...
                <tr>
                    <td align="center" bgcolor="#A37247" style="padding: 20px;">
                        <img loading="lazy" src="{{ $logoUrl }}" alt="Logo Royal" width="150"
                            style="display: block;">
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 30px; color: #371200;">
                        <h1 style="font-size: 22px; color: #4F2900; margin-bottom: 15px;">Detalles de la Nueva Solicitud
                        </h1>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 15px 0;">
                            ...
                            <li><strong>Teléfono:</strong> <span
                                    style="color: #A37247;">{{ $data['phone'] ?? 'N/A' }}</span></li>
                            <li><strong>Motivo de contacto:</strong> <span
                                    style="color: #A37247;">{{ $data['subject'] ?? 'N/A' }}</span></li>
                        </ul>
